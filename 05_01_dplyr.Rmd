...
data %>% 
  select(starts_with("verbundenheit_europa")) %>% 
  head()
```
...
data_eu %>% 
  select(lfdn, verbundenheit_europa, verbundenheit_deutschland, sieht_sich_als_europaeer) %>%   head()
```
