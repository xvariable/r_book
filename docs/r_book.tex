...
\texttt{summary()} & stats & Wichtige Verteilungsmerkmale &\tabularnewline
\texttt{describe()} & sjPlot & Tabelle deskriptiver Merkmale &\tabularnewline
\bottomrule
\end{longtable}
