...
\NormalTok{sign }\OtherTok{\textless{}{-}} \FunctionTok{case\_when}\NormalTok{(}
   \FunctionTok{glance}\NormalTok{(my\_model)}\SpecialCharTok{$}\NormalTok{p.value[[}\DecValTok{1}\NormalTok{]]}\SpecialCharTok{\textless{}}\FloatTok{0.001} \SpecialCharTok{\textasciitilde{}} \StringTok{"Das Modell ist auf dem Niveau p \textless{} .001 signifikant."}\NormalTok{,}
   \FunctionTok{glance}\NormalTok{(my\_model)}\SpecialCharTok{$}\NormalTok{p.value[[}\DecValTok{1}\NormalTok{]]}\SpecialCharTok{\textless{}}\FloatTok{0.01} \SpecialCharTok{\textasciitilde{}} \StringTok{"Das Modell ist auf dem Niveau p \textless{} .01 signifikant."}\NormalTok{,}
   \FunctionTok{glance}\NormalTok{(my\_model)}\SpecialCharTok{$}\NormalTok{p.value[[}\DecValTok{1}\NormalTok{]]}\SpecialCharTok{\textless{}}\FloatTok{0.05} \SpecialCharTok{\textasciitilde{}} \StringTok{"Das Modell ist auf dem Niveau p \textless{} .05 signifikant."}\NormalTok{,}
   \ConstantTok{TRUE} \SpecialCharTok{\textasciitilde{}} \StringTok{"Das Modell ist nicht signifikant."}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
